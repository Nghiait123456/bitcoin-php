...
echo "[Key: " . $privateKey->toWif() . " Address " . $privateKey->getAddress()->getAddress() . "]\n";
...
echo "[Send to: " . $recipient->getAddress() . " \n";
...
var_dump($new->getOutputs()->getOutput(0)->getAddress()->getAddress());
